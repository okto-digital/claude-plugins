# Domain: UX/UI Patterns & Benchmarks

**Document ID:** R4
**Output filename:** R4-ux-benchmarks.md
**Topic:** "UX/UI Patterns & Benchmarks"
**Wave:** 2
**Cross-topic inputs:** R2 (competitor URLs for benchmark site selection)
...
**Optional MCP:** none
**Crawling:** web-crawler dispatch for 3-5 benchmark site homepages and key pages (Steps 2-5)

**IMPORTANT:** This is a structural and visual audit, not a content analysis. Focus on patterns (how pages are organized, how users are guided) rather than messaging (what the copy says).
...
For each benchmark site, dispatch web-crawler and catalog the page types present:
...
Create a comparison matrix: which page types appear across all benchmark sites (universal) vs only some (optional).
