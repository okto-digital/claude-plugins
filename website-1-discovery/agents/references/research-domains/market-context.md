...
**Document ID:** R8
**Output filename:** R8-market-context.md
...
**Optional MCP:** none
**Crawling:** web-crawler dispatch for 1-2 URLs only (industry report summaries, association pages)

**IMPORTANT:** This is the lightest research topic -- primarily WebSearch-based. Focus on breadth of context rather than depth in any single area. The goal is market framing for the proposal, not a market research report.
...
**IMPORTANT:** Note source credibility for every market claim. Vendor reports often inflate growth to justify their products.
...
If the industry has no clear seasonal pattern, note this explicitly.
...
**IMPORTANT:** Be diplomatic in framing challenges.
