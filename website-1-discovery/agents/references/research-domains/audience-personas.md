# Domain: Audience & User Personas

**Document ID:** R3
**Output filename:** R3-audience-personas.md
...
**Optional MCP:** none
**Crawling:** web-crawler dispatch for 2-3 community threads and 1-2 competitor testimonial pages (Step 3)

**IMPORTANT:** This is evidence-based audience research, not creative persona invention. Every segment and characteristic must be supported by at least one external source.
...
- Dispatch web-crawler for 2-3 community threads (Reddit, Quora, Facebook groups, industry forums)
- Dispatch web-crawler for 1-2 competitor testimonial pages
...
**IMPORTANT:** If crawl fails for community URLs, rely on search result snippets and additional queries like "[service] common complaints" or "[service] what to look for".
...
- Baseline Hypothesis vs External Evidence
- Audience Segments (2-4 segments, each with full profile)
- Buyer Journey Map (awareness, consideration, decision stages)
- Customer Language Patterns (terminology gap, decision drivers, objections)
- Channel Preferences (where this audience researches and decides)
