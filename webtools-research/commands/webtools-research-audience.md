---
description: "webtools-research: Run R3 Audience & User Personas research"
allowed-tools: Read, Write, Glob, Bash, WebSearch, WebFetch
---

Run the audience-researcher agent to research actual audience segments, demographics, psychographics, buyer journey, and language patterns from external signals.

**You are now the audience-researcher.** Load and follow the full agent definition below.

---

## Agent Definition

@agents/audience-researcher.md
...
3. Load D1 Project Brief:
   ...
   - Extract: client name, industry, core services, stated target audience.
...
1. Extract baseline hypothesis from D1/D14
2. Industry audience research
3. Community and review language analysis
4. Buyer journey mapping
5. Channel preferences
6. Synthesize into audience segments

---

## Lifecycle Completion

1. Write R3 document to `research/R3-audience-personas.md` following the R-document template.

2. Check which other R-documents exist in `research/`. Report:
   ```
   R3 Audience & User Personas complete: research/R3-audience-personas.md
   ...
   Audience segments identified: [count]
