...
1. Identify the main content area (see `${CLAUDE_PLUGIN_ROOT}/references/web-crawler/formatting-rules.md` for selectors).
2. Apply all conversion rules from `${CLAUDE_PLUGIN_ROOT}/references/web-crawler/formatting-rules.md`.
