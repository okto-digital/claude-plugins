...
Apply formatting rules from `${CLAUDE_PLUGIN_ROOT}/references/web-crawler/formatting-rules.md` where possible:
...
Convert to markdown using the full rules in `${CLAUDE_PLUGIN_ROOT}/references/web-crawler/formatting-rules.md`:
