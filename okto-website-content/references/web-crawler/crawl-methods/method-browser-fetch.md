...
Using the `html` from the extraction result, convert to markdown following `${CLAUDE_PLUGIN_ROOT}/references/web-crawler/formatting-rules.md`. Supplement with the structured data:
